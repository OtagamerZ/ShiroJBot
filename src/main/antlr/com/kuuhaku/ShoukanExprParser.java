...
public class ShoukanExprParser extends Parser {
	...
	public static class LineContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ShoukanExprVisitor)
				return ((ShoukanExprVisitor<? extends T>) visitor).visitLine(this);
	...
	public static class SumSubContext extends ExprContext {
		...
		public TerminalNode SUM() {
			return getToken(ShoukanExprParser.SUM, 0);
		}

		public TerminalNode SUB() {
			return getToken(ShoukanExprParser.SUB, 0);
		}

		public SumSubContext(ExprContext ctx) {
			copyFrom(ctx);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ShoukanExprVisitor)
				return ((ShoukanExprVisitor<? extends T>) visitor).visitSumSub(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class FunctionContext extends ExprContext {
		...
		public TerminalNode MIN() {
			return getToken(ShoukanExprParser.MIN, 0);
		}

		public TerminalNode MAX() {
			return getToken(ShoukanExprParser.MAX, 0);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ShoukanExprVisitor)
				return ((ShoukanExprVisitor<? extends T>) visitor).visitFunction(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class GroupContext extends ExprContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ShoukanExprVisitor)
				return ((ShoukanExprVisitor<? extends T>) visitor).visitGroup(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MulDivContext extends ExprContext {
		...
		public TerminalNode MUL() {
			return getToken(ShoukanExprParser.MUL, 0);
		}

		public TerminalNode DIV() {
			return getToken(ShoukanExprParser.DIV, 0);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ShoukanExprVisitor)
				return ((ShoukanExprVisitor<? extends T>) visitor).visitMulDiv(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ValueContext extends ExprContext {
		...
		public TerminalNode VAR() {
			return getToken(ShoukanExprParser.VAR, 0);
		}

		public TerminalNode NUM() {
			return getToken(ShoukanExprParser.NUM, 0);
		}
		...
		public ValueContext(ExprContext ctx) {
			copyFrom(ctx);
		}
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if (visitor instanceof ShoukanExprVisitor)
				return ((ShoukanExprVisitor<? extends T>) visitor).visitValue(this);
			else return visitor.visitChildren(this);
		}
	}
