...
@Table(name = "frame_skin_info", schema = "shiro")
public class LocalizedFrameSkin extends DAO<LocalizedFrameSkin> implements Serializable {
	@EmbeddedId
	...
	public LocalizedFrameSkin setUwu(boolean uwu) {
		this.uwu = uwu;
		return this;
	}
	...
	public boolean equals(Object o) {
		...
		LocalizedFrameSkin that = (LocalizedFrameSkin) o;
