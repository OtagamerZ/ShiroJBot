...
@Table(name = "user_item_info", schema = "shiro")
public class LocalizedItem extends DAO<LocalizedItem> implements Serializable {
	...
	public LocalizedItem(I18N locale, String id, String name, String description) {
	...
	public LocalizedItem setUwu(boolean uwu) {
		this.uwu = uwu;
		return this;
	}
