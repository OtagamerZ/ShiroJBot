...
@Table(name = "unique_info", schema = "dunhun")
public class LocalizedUnique extends DAO<LocalizedUnique> implements Serializable {
	@EmbeddedId
	...
	public LocalizedUnique() {
	}

	public LocalizedUnique(I18N locale, String id, String name, String description) {
	...
	public LocalizedUnique setUwu(boolean uwu) {
		this.uwu = uwu;
		return this;
	}
	...
	public boolean equals(Object o) {
		...
		LocalizedUnique that = (LocalizedUnique) o;
