...
@Table(name = "run_modifier_info", schema = "dunhun")
public class LocalizedRunModifier extends DAO<LocalizedRunModifier> implements Serializable {
	@EmbeddedId
	...
	public LocalizedRunModifier setUwu(boolean uwu) {
		this.uwu = uwu;
		return this;
	}
	...
	public boolean equals(Object o) {
		...
		LocalizedRunModifier that = (LocalizedRunModifier) o;
