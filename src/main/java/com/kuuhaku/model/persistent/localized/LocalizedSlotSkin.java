...
@Table(name = "slot_skin_info", schema = "shiro")
public class LocalizedSlotSkin extends DAO<LocalizedSlotSkin> implements Serializable {
	@EmbeddedId
	...
	public LocalizedSlotSkin setUwu(boolean uwu) {
		this.uwu = uwu;
		return this;
	}
	...
	public boolean equals(Object o) {
		...
		LocalizedSlotSkin that = (LocalizedSlotSkin) o;
