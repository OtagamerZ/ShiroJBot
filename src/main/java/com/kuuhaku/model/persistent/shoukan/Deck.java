 ...
 public class Deck extends DAO<Deck> {
	 ...
	 public BufferedImage render(I18N locale) {
		 ...
		 g2d.setFont(Fonts.NOTO_SANS.deriveFont(Font.PLAIN, 30));
		 ...
		 Graph.applyTransformed(g2d, 30, 520, g -> {
			 ...
			 if (ori.isPure()) {
				 ...
				 g.setFont(Fonts.NOTO_SANS.deriveFont(Font.BOLD, 60));
