...
@Table(name = "archetype_info")
public class LocalizedArch extends DAO<LocalizedArch> implements Serializable {
	@EmbeddedId
	...
	public LocalizedArch setUwu(boolean uwu) {
		this.uwu = uwu;
		return this;
	}
	...
	public boolean equals(Object o) {
		...
		LocalizedArch that = (LocalizedArch) o;
