...
public class Profile extends DAO<Profile> implements Blacklistable {
	...
	public BufferedImage render(I18N locale) {
		...
		Graph.applyTransformed(g2d, g1 -> {
			...
			g1.setFont(Fonts.OPEN_SANS_BOLD.deriveFont(20));
		...
		g2d.setFont(Fonts.DOREKING.deriveFont(55));
		...
		g2d.setFont(Fonts.OPEN_SANS_BOLD.deriveFont(25));
		...
		if (title != null) {
			...
			g2d.setFont(Fonts.DOREKING.deriveFont(35));
