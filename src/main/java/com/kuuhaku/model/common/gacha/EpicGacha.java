...
@GachaType(value = "common", price = 10, prizes = 1, currency = Currency.ITEM, itemCostId = "EPIC_SHARD")
public class EpicGacha extends Gacha {
	public EpicGacha(User u) {
		super(DAO.queryAllUnmapped("""
				...
				WHERE a.visible
				  AND get_rarity_index(c.rarity) = 4
