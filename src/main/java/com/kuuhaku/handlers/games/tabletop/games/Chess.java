...
public class Chess extends Tabletop {
	...
	public Chess(TextChannel table, String id, User... players) {
		...
		getBoard().setPattern(new Piece[][]{
				...
				{pieces.get(players[1]).get(8), null, null, null,/*pieces.get(players[1]).get(9), pieces.get(players[1]).get(10), pieces.get(players[1]).get(11),*/ pieces.get(players[1]).get(12), null, null,/*pieces.get(players[1]).get(13), pieces.get(players[1]).get(14),*/ pieces.get(players[1]).get(15)}
