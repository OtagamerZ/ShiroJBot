...
public enum FrameColor {
	...
	LEGACY_PINK("Empoeirado e gasto, trazendo a perspicácia de um tempo distante.", Account::isOldPlayer),
	LEGACY_PURPLE("Empoeirado e gasto, mostrando a dominação de um tempo distante.", Account::isOldPlayer),
	LEGACY_BLUE("Empoeirado e gasto, meditando sobre a sabedoria de um tempo distante.", Account::isOldPlayer),
	LEGACY_CYAN("Empoeirado e gasto, relembrando suas vitórias passadas.", Account::isOldPlayer),
	LEGACY_GREEN("Empoeirado e gasto, mas verde como um grande pinheiro de outrora.", Account::isOldPlayer),
	LEGACY_YELLOW("Empoeirado e gasto, com uma tecnologia a muito tempo perdida.", Account::isOldPlayer),
	LEGACY_RED("Empoeirado e gasto, ainda sujo com o sangue de seus inimigos.", Account::isOldPlayer),
	LEGACY_GRAY("Empoeirado e gasto, praticamente desbotado mas afiado.", Account::isOldPlayer),
