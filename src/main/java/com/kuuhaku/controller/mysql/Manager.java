...
public class Manager {
	...
	public static EntityManager getEntityManager() {
		...
		props.put("javax.persistence.jdbc.url", "jdbc:mysql://" + System.getenv("SERVER_URL") + "/Shiro?serverTimezone=EST5EDT&amp;autoReconnect=true&amp;useUnicode=yes&amp;characterEncoding=UTF-8&amp;interactiveClient=true");
