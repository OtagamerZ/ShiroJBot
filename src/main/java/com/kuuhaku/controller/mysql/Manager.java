...
public class Manager {
	...
	public static EntityManager getEntityManager() {
		...
		props.put("javax.persistence.jdbc.url", "jdbc:postgresql://localhost/Shiro?serverTimezone=EST5EDT&autoReconnect=true&useUnicode=yes&characterEncoding=UTF-8&interactiveClient=true");
