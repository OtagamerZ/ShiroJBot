...
public class GifSequenceWriter {
	...
	private void configureRootMetadata(int dispose, int delay, int loop) throws IIOInvalidTreeException {
	...
	public void writeToSequence(RenderedImage img, int dispose, int delay, int loop) throws IOException {
