    ...
    public void execute(User author, Member member, String rawCmd, String[] args, Message message, MessageChannel channel, Guild guild, Event event, String prefix) {
        ...
        channel.sendMessage("<a:Loading:598500653215645697> Buscando anime...").queue(m -> {
            try {
                ...
                eb.addField("Assista em:", Helper.compareWithValues(com.kuuhaku.controller.Anime.getLink(anime.gettRomaji()), 403, 404) ? "Link indisponível" : "https://www.dreamanimes.com.br/anime-info/" + anime.gettRomaji().replace(" ", "-"), true);
