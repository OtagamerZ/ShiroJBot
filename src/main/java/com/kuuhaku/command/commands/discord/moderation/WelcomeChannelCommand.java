...
@Command(
		name = "canalbemvindo",
		aliases = {"canalbv", "welcomechannel"},
...
public class WelcomeChannelCommand implements Executable {
	...
	public void execute(User author, Member member, String command, String argsAsText, String[] args, Message message, TextChannel channel, Guild guild, String prefix) {
		...
		if (Helper.equalsAny(args[0], "limpar", "reset")) {
			...
			gc.setWelcomeChannel(message.getMentionedChannels().get(0).getId());
			channel.sendMessage("✅ | Canal de boas-vindas definido com sucesso.").queue();
		}
