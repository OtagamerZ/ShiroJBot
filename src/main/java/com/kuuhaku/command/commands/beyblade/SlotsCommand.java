...
public class SlotsCommand extends Command {
	...
	public void execute(User author, Member member, String rawCmd, String[] args, Message message, MessageChannel channel, Guild guild, Event event, String prefix) {
		...
		try {
			...
			int wow = Collections.frequency(result, "<a:Wow:598497560734203926>");
			...
			channel.sendMessage("Aposta de " + author.getAsMention() + ": :diamond_shape_with_a_dot_inside: " + aposta[0] + " pontos.").queue(m -> {
				...
				switch (rosette) {
					case 3:
						...
						break;
					case 4:
						aposta[0] += Math.round((float) aposta[0] * 3.0f);
						break;
					case 5:
						aposta[0] += Math.round((float) aposta[0] * 4.0f);
						break;
				}
				switch (wow) {
					case 3:
						...
						break;
					case 4:
						aposta[0] += Math.round((float) aposta[0] * 5f);
						break;
					case 5:
						aposta[0] += Math.round((float) aposta[0] * 7.5f);
						break;
				}
