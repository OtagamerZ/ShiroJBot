...
public class RoleChooserCommand extends Command {
    ...
    public RoleChooserCommand() {
        super("botaocargo", new String[]{"rolebutton", "bc", "rb"}, "<ID> <emote> <@cargo>", "Adiciona botões de cargo na mensagem informada.", Category.MODERACAO);
    }
    ...
    public void execute(User author, Member member, String rawCmd, String[] args, Message message, MessageChannel channel, Guild guild, String prefix) {
        ...
        if (args.length < 3) {
            ...
            channel.sendMessage(":x: | É necessário informar o emote a ser usado como botão.").queue();
            return;
        ...
        jo.put("button", message.getEmotes().get(0).getName());
