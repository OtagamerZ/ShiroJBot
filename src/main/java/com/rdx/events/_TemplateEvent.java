...
//		eb.setThumbnail(THUMBNAIL_URL);//guild.getIconUrl() - user.getAvatarUrl();
//		eb.setColor(COR_AQUI); //3721574
//	
//	    eb.setDescription("Linha 1\n"
//			    + "Linha 2\n"
//			    + "Linha 3");
//		
//		eb.setTimestamp(Instant.now());
//		eb.setFooter(com.kuuhaku.MainANT.getInfo().getFullName(), null);
//
