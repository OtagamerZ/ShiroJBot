...
public class Arena {
    /*public static void start(MessageReceivedEvent message, String[] cmd) {
        if (Database.getBeyblade(message.getAuthor().getId()) == null) {
            if (cmd.length > 1) {
                ...
                message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Parabéns, você acabou de obter sua mais nova Beyblade!").queue());
            } else {
                message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Você precisa dar um nome a sua Beyblade!").queue());
            }
        } else {
            message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Você já possui uma Beyblade!").queue());
        }
    }
    ...
    public static void setCor(MessageReceivedEvent message, String[] cmd) {
        ...
        if (bb == null) message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Você não possui uma Beyblade!").queue());
            ...
            if (cmd[1].contains("#") && cmd[1].length() == 7) {
                bb.setColor(cmd[1]);
                Database.sendBeyblade(bb);
                message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Cor setada com sucesso!").queue());
            } else {
                message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("A cor precisa estar neste formato: `#RRGGBB`").queue());
            }
        } else {
            message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Você precisa especificar uma cor!").queue());
        }
    }
    ...
    public static void setName(MessageReceivedEvent message, String[] cmd) {
        ...
        if (bb == null) message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Você não possui uma Beyblade!").queue());
            ...
            message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Você não possui pontos de combate suficiente!").queue());
        else if (cmd.length > 1) {
            if (message.getMessage().getContentRaw().replace(cmd[0], "").trim().length() < 20) {
                bb.setName(message.getMessage().getContentRaw().replace(cmd[0], "").trim());
                bb.takePoints(50);
                message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Nome trocado com sucesso!").queue());
            } else {
                message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("O nome que você escolheu possui mais de 20 caracteres, por favor escolha um nome mais curto.").queue());
            }
        } else {
            message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Você não me disse um nome!").queue());
        }
    }
    ...
    public static void upgrade(MessageReceivedEvent message, String[] cmd) {
        Beyblade bb = Database.getBeyblade(message.getAuthor().getId());
        final Consumer<Void> noBeyblade = tm -> message.getChannel().sendMessage("Você não possui uma Beyblade!").queue();
        final Consumer<Void> notEnoughPoints = tm -> message.getChannel().sendMessage("Você não possui pontos de combate suficiente!").queue();
        switch (cmd[1]) {
            case "nome":
                if (bb == null) message.getChannel().sendTyping().queue(noBeyblade);
                else if (bb.getPoints() < 50)
                    message.getChannel().sendTyping().queue(notEnoughPoints);
            ...
            case "força":
                if (bb == null) message.getChannel().sendTyping().queue(noBeyblade);
                    ...
                    bb.addStrength();
                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Poder aumentado com sucesso!").queue());
                }
                break;
            case "velocidade":
                if (bb == null) message.getChannel().sendTyping().queue(noBeyblade);
                    ...
                    bb.addSpeed();
                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Velocidade aumentada com sucesso!").queue());
                }
                break;
            case "estabilidade":
                if (bb == null) message.getChannel().sendTyping().queue(noBeyblade);
                    ...
                    bb.addStability();
                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Estabilidade aumentada com sucesso!").queue());
                }
                break;
            case "vida":
                if (bb == null) message.getChannel().sendTyping().queue(noBeyblade);
                    ...
                    bb.addLife();
                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Vida aumentada com sucesso!").queue());
                }
                break;
            default:
                message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("O atributo especificado não é válido!").queue());
        }
    }
    ...
    public static void duel(MessageReceivedEvent message, Map<Long, DuelData> duels) {
        if (message.getMessage().getMentionedUsers().size() > 0) {
            if (Database.getBeyblade(message.getMessage().getMentionedUsers().get(0).getId()) != null) {
                ...
                if (duels.containsValue(dd)) message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Você já possui um duelo pendente!").queue());
                else message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage(message.getMessage().getMentionedMembers().get(0).getAsMention() + ", você foi desafiado a um duelo de beyblades por " + message.getAuthor().getAsMention() + ". Se deseja aceitar, clique no botão abaixo:").queue(m -> {
                            m.addReaction("\u21aa").queue();
    ...
    public static void battle(List<DuelData> accDuels, MessageReceivedEvent message) {
        ...
        if (message.getMessage().getContentRaw().equalsIgnoreCase("atacar")) {
            if (player1Turn && message.getAuthor() == duel.getP1()) {
                ...
                message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage(duel.getB1().getName() + " ataca, agora é a vez de " + duel.getB2().getName()).queue());
                ...
                message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage(duel.getB2().getName() + " ataca, agora é a vez de " + duel.getB1().getName()).queue());
            }
        } else if (message.getMessage().getContentRaw().equalsIgnoreCase("defender")) {
            if (player1Turn && message.getAuthor() == duel.getP1()) {
                duel.setP1turn(false);
                duel.setD1(true);
                message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage(duel.getB1().getName() + " assumiu uma postura defensiva, é a vez de " + duel.getB2().getName()).queue());
            } else if (!player1Turn && message.getAuthor() == duel.getP2()) {
                duel.setP1turn(true);
                duel.setD2(true);
                message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage(duel.getB2().getName() + " assumiu uma postura defensiva, é a vez de " + duel.getB1().getName()).queue());
            }
            ...
            if (duel.getB1().getS() != null) {
                if (!duel.isS1()) {
                    if (player1Turn && message.getAuthor() == duel.getP1()) {
                        ...
                        switch (duel.getB1().getSpecial()) {
                            case 11:
                                if (chance > duel.getB1().getS().getDiff() - duel.getB1().getSpeed()) {
                                    ...
                                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("O-O que?? " + duel.getB1().getName() + " desapareceu? Ah, lá está ela, com um movimento digno dos tigres ela executa o golpe especial " + duel.getB1().getS().getName() + "! (" + chance + " > " + duel.getB1().getS().getDiff() + ")").queue());
                                    duel.setS1(true);
                                    if (duel.getB2().getS() != null) duel.getB2().getS().setBear(false);
                                } else {
                                    message.getChannel().sendTyping().queue(Miss);
                                }
                                break;
                            case 12:
                                if (chance > duel.getB1().getS().getDiff() - duel.getB1().getSpeed()) {
                                    ...
                                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Isso foi incrível!! " + duel.getB1().getName() + " executou com perfeição em " + duel.getB1().getS().getName() + " um dos golpes mais difíceis já conhecidos! (" + chance + " > " + duel.getB1().getS().getDiff() + ")").queue());
                                    duel.setP1turn(true);
                                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage(duel.getB2().getName() + " está atordoada, será que teremos uma reviravolta aqui?").queue());
                                    duel.setS1(true);
                                    if (duel.getB2().getS() != null) duel.getB2().getS().setBear(false);
                                } else {
                                    message.getChannel().sendTyping().queue(Miss);
                            ...
                            case 21:
                                if (chance > duel.getB1().getS().getDiff() - duel.getB1().getSpeed()) {
                                    ...
                                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("O que foi isso!? " + duel.getB1().getName() + " lançou " + duel.getB1().getS().getName() + " ao ar, depois o lançou utilizando sua própria defesa! (" + chance + " > " + duel.getB1().getS().getDiff() + ")").queue());
                                    duel.setS1(true);
                                    if (duel.getB2().getS() != null) duel.getB2().getS().setBear(false);
                                } else {
                                    message.getChannel().sendTyping().queue(Miss);
                            ...
                            case 22:
                                if (chance > duel.getB1().getS().getDiff() - duel.getB1().getSpeed()) {
                                    ...
                                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Não é possível!! Eu jamais acreditaria se alguém me dissesse que era possível executar este golpe, mas " + duel.getB1().getName() + " provou que é possivel!!! " + duel.getB1().getS().getName() + " mal consegue se manter em pé! (" + chance + " > " + duel.getB1().getS().getDiff() + ")").queue());
                                    duel.setS1(true);
                                    if (duel.getB2().getS() != null) duel.getB2().getS().setBear(false);
                                } else {
                                    message.getChannel().sendTyping().queue(Miss);
                            ...
                            case 31:
                                if (chance > duel.getB1().getS().getDiff() - duel.getB1().getSpeed()) {
                                    ...
                                    duel.setD1(true);
                                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Mais alguém está sentindo isso? " + duel.getB1().getName() + " acaba de executar a assinatura dos ursos!! Essa aura poderá virar o fluxo da partida! (" + chance + " > " + duel.getB1().getS().getDiff() + ")").queue());
                                    duel.setS1(true);
                                } else {
                                    message.getChannel().sendTyping().queue(Miss);
                                }
                        ...
                        message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("O poder mágico de " + duel.getB1().getName() + " já está no limite, não me parece que conseguirá realizar mais um golpe especial!").queue());
                    }
                } else {
                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage(duel.getB1().getName() + " ainda não possui um alinhamento!").queue());
                }
            } else if (!player1Turn && message.getAuthor() == duel.getP2()) {
                if (duel.getB2().getS() != null) {
                    if (!duel.isS2()) {
                        ...
                        switch (duel.getB2().getSpecial()) {
                            case 11:
                                if (chance > duel.getB2().getS().getDiff() - duel.getB2().getSpeed()) {
                                    ...
                                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("O-O que?? " + duel.getB2().getName() + " desapareceu? Ah, lá está ele, com um movimento digno dos tigres ele executa o golpe especial " + duel.getB2().getS().getName() + "! (" + chance + " > " + duel.getB2().getS().getDiff() + ")").queue());
                                    duel.setS2(true);
                                    if (duel.getB1().getS() != null) duel.getB1().getS().setBear(false);
                                } else {
                                    message.getChannel().sendTyping().queue(Miss);
                            ...
                            case 12:
                                if (chance > duel.getB2().getS().getDiff() - duel.getB2().getSpeed()) {
                                    ...
                                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Isso foi incrível!! " + duel.getB2().getName() + " executou com perfeição em " + duel.getB2().getS().getName() + " um dos golpes mais difíceis já conhecidos! (" + chance + " > " + duel.getB2().getS().getDiff() + ")").queue());
                                    duel.setP1turn(false);
                                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage(duel.getB1().getName() + " está atordoada, será que teremos uma reviravolta aqui?").queue());
                                    duel.setS2(true);
                                    if (duel.getB1().getS() != null) duel.getB1().getS().setBear(false);
                                } else {
                                    message.getChannel().sendTyping().queue(Miss);
                            ...
                            case 21:
                                if (chance > duel.getB2().getS().getDiff() - duel.getB2().getSpeed()) {
                                    ...
                                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("O que foi isso!? " + duel.getB2().getName() + " lançou " + duel.getB2().getS().getName() + " ao ar, depois o lançou utilizando sua própria defesa! (" + chance + " > " + duel.getB2().getS().getDiff() + ")").queue());
                                    duel.setS2(true);
                                    if (duel.getB1().getS() != null) duel.getB1().getS().setBear(false);
                                } else {
                                    message.getChannel().sendTyping().queue(Miss);
                            ...
                            case 22:
                                if (chance > duel.getB2().getS().getDiff() - duel.getB2().getSpeed()) {
                                    ...
                                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Não é possível!! Eu jamais acreditaria se alguém me dissesse que era possível executar este golpe, mas " + duel.getB2().getName() + " provou que é possivel!!! " + duel.getB2().getS().getName() + " mal consegue se manter em pé! (" + chance + " > " + duel.getB2().getS().getDiff() + ")").queue());
                                    duel.setS2(true);
                                    if (duel.getB1().getS() != null) duel.getB1().getS().setBear(false);
                                } else {
                                    message.getChannel().sendTyping().queue(Miss);
                            ...
                            case 31:
                                if (chance > duel.getB2().getS().getDiff() - duel.getB2().getSpeed()) {
                                    ...
                                    duel.setD2(true);
                                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("Mais alguém está sentindo isso? " + duel.getB2().getName() + " acaba de executar a assinatura dos ursos!! Essa aura poderá virar o fluxo da partida! (" + chance + " > " + duel.getB2().getS().getDiff() + ")").queue());
                                    duel.setS2(true);
                                } else {
                                    message.getChannel().sendTyping().queue(Miss);
                                }
                        ...
                        message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage("O poder mágico de " + duel.getB2().getName() + " já está no limite, não me parece que conseguirá realizar mais um golpe especial!").queue());
                    }
                } else {
                    message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage(duel.getB2().getName() + " ainda não possui um alinhamento!").queue());
                }
            }
        } else if (message.getMessage().getContentRaw().equalsIgnoreCase("desistir")) {
            if (message.getAuthor() == duel.getP1()) {
                message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage(duel.getP1().getAsMention() + " desistiu. A vitória é de " + duel.getP2().getAsMention() + "!").queue());
                ...
                message.getChannel().sendTyping().queue(tm -> message.getChannel().sendMessage(duel.getP2().getAsMention() + " desistiu. A vitória é de " + duel.getP1().getAsMention() + "!").queue());
